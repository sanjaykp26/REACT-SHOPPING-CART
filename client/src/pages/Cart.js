...
import {userRequest} from "../reguestMethods"
import { useNavigate } from "react-router";
import { NavLink } from 'react-router-dom'
import { Link } from 'react-router-dom';
import DeleteIcon from '@mui/icons-material/Delete';
import { decreaseCart, removeFromCart } from '../redux/cartRedux'
...
flex-direction: column;
`
const PrdouctAmountContainer=styled.div`
...
//   };
 ...
 const handleDecreaseCart=(products)=>{
  ...
  // const carfromlocalstorage=JSON.parse(localStorage.getItem("cart"))||"[]"
  return (
    <Container>
        <Navbar/>
        {/* <Announcements/> */}
        <Wrapper>
            ...
            <Bottom>
              ...
              {/* <StripeCheckout name="sanjay shop"
        image='https://i.postimg.cc/yd7n8Q7n/gears-war-318-661029.png'
        billingAddress
        shippingAddress
